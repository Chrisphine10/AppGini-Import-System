...
<button class="btn btn-outline-secondary" style="margin:2px;" onclick="printContent('print')">Print</button>
<div class="card-header">
<h1>Company Name</h1>

	</div>
<div class="card m-2" id="print" style="height: 500px;overflow-x: scroll;">
