<?php
	...
	$schema = array(   
		'contacts' => array(   
			...
			'entity' => array('appgini' => 'VARCHAR(40) '),
		...
		'shipping_db' => array(   
			...
			'description' => array('appgini' => 'VARCHAR(40) '),
			'shipping' => array('appgini' => 'INT unsigned '),
			'date_ordered' => array('appgini' => 'DATE '),
			'bol_date' => array('appgini' => 'DATE '),
			'bol_date_status' => array('appgini' => 'VARCHAR(40) '),
			'designation' => array('appgini' => 'VARCHAR(40) '),
			'status' => array('appgini' => 'VARCHAR(40) '),
			'unit' => array('appgini' => 'VARCHAR(40) '),
			'quantity' => array('appgini' => 'FLOAT(10,2) '),
			'currency' => array('appgini' => 'VARCHAR(40) '),
			'unit_price' => array('appgini' => 'FLOAT(10,2) default \'0.00\' '),
			'total_price' => array('appgini' => 'FLOAT(10,2) default \'0.00\' '),
			'payment_terms' => array('appgini' => 'VARCHAR(40) '),
			'due' => array('appgini' => 'VARCHAR(40) '),
			'profoma_invoice' => array('appgini' => 'VARCHAR(40) '),
			'copy_invoice' => array('appgini' => 'VARCHAR(40) '),
			'commercial_invoice' => array('appgini' => 'VARCHAR(40) '),
			'bill_of_ladding' => array('appgini' => 'VARCHAR(40) '),
			'clearing_document' => array('appgini' => 'VARCHAR(40) '),
			'other_documents' => array('appgini' => 'VARCHAR(40) '),
			'logged_by' => array('appgini' => 'VARCHAR(40) '),
			'bol_status' => array('appgini' => 'VARCHAR(40) ')
		)
	);
