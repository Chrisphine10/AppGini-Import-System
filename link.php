<?php
	...
	$p=array(   
		'shipping_db' => array(
			'copy_invoice' => $Translation['ImageFolder'],
			'commercial_invoice' => $Translation['ImageFolder'],
			'bill_of_ladding' => $Translation['ImageFolder'],
			'clearing_document' => $Translation['ImageFolder'],
			'other_documents' => $Translation['ImageFolder'],
			'primary key' => 'id'
		)
	);
